...
public class DB {
	 ...
	 */
	public static String addEp(String parentId, String link, String title, String body, String authorId, Date date) throws DBException {
		synchronized (epLock) {
		Session session = openSession();
		try {
	...
	private static List<String> getPathIds(String id) {
		String[] arr = id.split("-");
